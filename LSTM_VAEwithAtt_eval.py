...
from LSTM_VAEwithAtt import LSTMAutoencoderWithAttention
...
model = LSTMAutoencoderWithAttention(seq_len=1164, n_features=130, embedding_dim=16, attention_hidden_dim=4).to(DEVICE)
...
model.load_state_dict(torch.load("voraus-ad-dataset-main\LSTM_VAEWithAtt16.pth"))
